...
private:
	void DrawTiles(sf::RenderWindow &target, int topX, int topY, int width, int height, World& world, int worldX, int worldY, int tileSize, int mouseTileX, int mouseTileY);
	struct GameImpl;
	GameImpl* data;
};
